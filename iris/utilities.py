...
def cost_buffer_string_to_parameter_histories(string, params, cost_iters):
    ...
    string : `str`
        a string
    params : iterable
        an iterable (usually a list) of the parameter histories
    ...
    """
    allcosts = np.asarray(string.splitlines(), dtype=np.float64)
